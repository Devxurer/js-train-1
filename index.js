...
function checkDataType(value) {
  const dataTypeCheck = typeof value;
  console.log(`Значення ${value} has ${dataTypeCheck}`);
...
function getVariableType(variable) {
  const variableTypeCheck = typeof variable;

  const message =
    variableTypeCheck === "number"
      ? "This is number"
      : variableTypeCheck === "string"
      ? "This is string"
      : variableTypeCheck === "boolean"
      ? "This is bollean"
